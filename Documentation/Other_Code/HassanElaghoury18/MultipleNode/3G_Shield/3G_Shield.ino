// This sketch only utilizes the 3G shield (no LoRa communication at all) to send a random value to either Thingspeak or McMaster. Should avoid using String objects
