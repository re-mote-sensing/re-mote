...
To order the correct products, please read the article [here](../../Setup/Water_Quality_Setup.md) and read the 'The Hardware You Need' section. These parts will be needed to accomplish the assembly task. 
