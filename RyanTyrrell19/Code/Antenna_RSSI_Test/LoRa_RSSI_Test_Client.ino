/*
 Name:		LoRa_RSSI_Test_Client.ino
 Created:	6/11/2019 12:54:52 PM
 Author:	tyrre
*/
...
uint16_t gatewayId = 0x0001;
uint8_t* rssi = (uint8_t*)malloc(sizeof(uint8_t) * 1);
...
void loop() {
	...
	sendData(loraPort, gatewayId, 1, rssi);
